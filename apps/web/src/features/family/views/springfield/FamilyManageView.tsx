 ...
 *
 * Theme `springfield` (estética cómic pop). Pantalla "Gestionar familia" (solo
 * OWNER): gestión de miembros (cambiar rol / expulsar), edición del nombre y
 * descripción, y borrado de la familia. Extraída de la home a su propia pantalla.
 *
